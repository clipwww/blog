      ...
      >
        ...
        <footer>
          <div
            ...
            class="ui-post-meta ui-post-author text-gray-400"
          ...
          <div v-if="page.frontmatter.date" class="ui-post-meta ui-post-date text-gray-500 dark:text-gray-300">
            <ClockIcon />
            <time
              pubdate
          ...
          <div
            ...
            class="ui-post-meta ui-post-tag text-gray-500 dark:text-gray-300"
            itemprop="keywords"
          >
            <TagIcon />
            <router-link
